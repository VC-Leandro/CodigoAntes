        ...
        <div class="row">
          <div class="col-lg-8 offset-lg-2"> 
            ...
            <div class="row py-3 emsb-filter-search-container">   
              <div class="col-sm-6">
              <form action="<?php echo esc_url( home_url( '/marcacao/') ); ?>" method="GET" id="emsb_sort_archive">
                  <select class="form-control chosen-select" data-placeholder="<?php _e( 'Choose a Service Type... ', 'emsb-service-booking' ); ?>" name="service_type" id="emsb_sort_archive_btn" onchange="submit();">
                    <option value="show-all" <?php if(isset($_GET['service_type']) && $_GET['service_type'] == 'show-all'){ echo 'selected="selected"'; } else {'';}; ?>> <?php _e( 'Especialidades ', 'emsb-service-booking' ); ?> </option>
                    <?php 
              ...
              <div class="col-sm-6">
                <form action="<?php echo esc_url( home_url( '/marcacao/') ); ?>" role="search" class="emsb-serch-form"  method="get" id="searchform">
                    <div class="input-group">
                      <input type="text" class="form-control" name="emsb_search" placeholder="Procurar">
                      <div class="input-group-append">
                        <button class="btn emsb-search-btn" type="submit">
                           <?php _e( 'Procurar', 'emsb-service-booking' ); ?>
                        </button>
                      </div>
              ...
              while ( $emsb_query->have_posts() ) :
                ...
                ?>
                  <article id="post-<?php the_ID(); ?>"  class="em-service">
                          ...
                          <div class="em-service-excerpt-info">
                            ...
                            <?php 
                              ...
                              if($emsb_display_service_location){ ?>
                                  <p class="emsb-service-location"><?php _e( 'Local de Atendimento: ', 'emsb-service-booking' ); ?> <?php echo $emsb_display_service_location; ?> </p>
                              <?php 
                                  }
                              ?>
                              <?php 
                      ...
                      <button type="button" class="btn btn-light mb-2 em-select-service-button"> <?php _e( 'Selecionar', 'emsb-service-booking' ); ?> </button>
      ...
      <div class="em-reservation-div-position em-hide">
          ...
          <div class="em-selected-all-wrapper">
            <div class="em-selected-service">
              ...
              <button  class="btn em-change-service-btn"> <?php _e( 'Trocar de Médico', 'emsb-service-booking' ); ?></button>
            </div>
            <div class="em-selected-date-wrapper">
              <div class="em-selected-date d-flex align-items-center">
                  <label class="date"></label>
                  <button  class="btn ml-sm-5 em-change-date-btn"> <?php _e( 'Alterar Data', 'emsb-service-booking' ); ?></button>
              </div>
            </div>
            <div class="em-selected-time-slot-wrapper">
              <div class="em-selected-time-slot d-flex align-items-center">
                  ...
                  <button  class="btn ml-sm-5 em-change-time-slot-btn"> <?php _e( 'Alterar Horário', 'emsb-service-booking' ); ?></button>
              </div>
            </div>
          ...
          <div class="em-timer">
            ...
            <div id="em-accordion" class="my-3 em-am-time ">
              <div class="am-or-pm">
                  <button id="amButton"  class="btn btn-light mb-2 em-am-button active mr-1"><span> <?php _e( 'Manhã ( AM )', 'emsb-service-booking' ); ?></span></button>
                  <button id="pmButton"  class="btn btn-light mb-2 em-pm-button ml-1" ><span> <?php _e( 'Tarde ( PM ) ', 'emsb-service-booking' ); ?></span></button>
              </div>
          ...
          <div class="em-booking-form-container">
            <form method="post" class="needs-validation" novalidate <?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>>
              <div class="em-booking-form-fields">
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    <input name="emsb_user_fullName" type="text" class="form-control" id="emsb_user_fullName" placeholder="<?php _e( 'Digite o nome completo ', 'emsb-service-booking' ); ?>" value="" required>
                    <div class="invalid-feedback">
                      <?php _e( 'Digite seu nome completo! ', 'emsb-service-booking' ); ?>
                    </div>
                  </div>
                </div>
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                      <div>
                        <input name="emsb_user_email" type="email" class="form-control" id="emsb_user_email" placeholder="<?php _e( 'Digite o endereço de E-mail ', 'emsb-service-booking' ); ?>" required>
                        <div class="invalid-feedback">
                          <?php _e( 'Digite um E-mail válido! ', 'emsb-service-booking' ); ?>
                        </div>
                      </div>
                    </div>
                </div>
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    <input name="emsb_user_telephone" id="emsb_user_telephone" type="tel" maxlength="25" size="40" class="form-control"  placeholder="<?php _e( 'Digite o número de contato ', 'emsb-service-booking' ); ?>" required>
                    <div class="invalid-feedback">
                      <?php _e( 'Digite um número válido! ', 'emsb-service-booking' ); ?>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <button id="submitForm" class="btn btn-light em-confirm-booking-button" name="emsb_submit_booking" type="submit" value="Submit"> <?php _e( 'Enviar Solicitação', 'emsb-service-booking' ); ?> </button>
            </form>
          </div>
